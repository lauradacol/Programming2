	...
	<div class="container">
		...
		<section class="col-2">
			...
			if(!is_numeric($_GET['id'])){
				...
				else {//else is numeric
				
					$id = $_GET['id'];								
					$sql = "select produto.id, fabricante.nome as fabricante, produto.nome as nome, imagem, valor, desconto, tensao, descricao, catMarcenaria, catJardinagem, catLimpeza, catEscritorio, catMecanica, catOutros from produto left join fabricante on fabricante.id = produto.idFabricante where produto.id like '$id'";
					...
					<?php				
						if(mysqli_num_rows($resultado) == 0){
							echo "<h2>Produto Inexistente</h2>";
						}
						else{				
					?>
